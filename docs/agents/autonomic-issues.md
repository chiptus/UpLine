...
1. Create the labels: `agent:wip`, `agent:pr`, `epic`, `priority:high`, `priority:low` (triage vocabulary from `docs/agents/triage-labels.md` plus `bug`/`enhancement`/`chore` should already exist).
