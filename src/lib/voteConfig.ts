...
export const VOTE_CONFIG = {
  mustGo: {
    ...
    buttonSelected: "bg-vote-must hover:bg-vote-must/90",
    buttonUnselected:
  ...
  interested: {
    ...
    buttonSelected: "bg-vote-interested hover:bg-vote-interested/90",
    buttonUnselected:
  ...
  wontGo: {
    ...
    buttonSelected: "bg-vote-skip hover:bg-vote-skip/90",
    buttonUnselected:
